...
(* align_width="a,b,c,out" *) module add_addrcalc(
  ...
  assign c1={12'b0,c[31:0],3'b0} & {44{shift[0]}};
  assign c2={11'b0,c[31:0],4'b0} & {44{shift[1]}};
  assign c3={10'b0,c[31:0],5'b0} & {44{shift[2]}};
  assign c4={9'b0,c[31:0],6'b0} & {44{shift[3]}};
